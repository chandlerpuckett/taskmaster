...
public final class NewFile implements Model {
  ...
  private final @ModelField(targetType="TaskItem", isRequired = true) @BelongsTo(targetName = "newFileBelongsToId", type = TaskItem.class) TaskItem belongsTo;
  public String getId() {
      return id;
  }
  ...
  public NewFile(String id, String name, TaskItem belongsTo) {
    this.id = id;
    this.name = name;
